...
GANHADOR_X = (1,1,1)
EMPATE = (0,0,0)
ESTRATEGIA = ('basico','normal','perfeito') 
...
def eh_posicao(pos):
    ...
    seus argumento corresponde a uma posicao e False caso contrario, sem nunca 
    gerar erros.
    """
...
def obter_diagonal(tab,inteiro):
    ...
    # obter_diagonal: tabuleiro x inteiro -> vecto
    """
...
########################################
# Funções de manipualação do tabuleiro #            
########################################
...
def canto_oposto(tab,inteiro):
    ...
    """
    adversario = JOGADORES[1] if inteiro == JOGADORES[0] else JOGADORES[0]
